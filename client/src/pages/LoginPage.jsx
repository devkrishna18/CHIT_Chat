  ...
  return (
    ...
    {/* right */}
      ...
      flex flex-col gap-6 rounded-lg shadow-lg'>
       ...
       {!isDataSubmitted &&( <input 
        onChange={(e)=> setpass(e.target.value)} value={pass}  type="password" className='border border-gray-500 rounded-md focus:outline-none p-2'
        placeholder='Password' required />
)}

{isDataSubmitted && currState==='Sign Up' &&(
  <textarea onChange={(e)=>setbio(e.target.value)} vlaue={bio} rows={4}  className='p-2 border border-gray-500 rounded-md focus:outline-none focus:ring-2
