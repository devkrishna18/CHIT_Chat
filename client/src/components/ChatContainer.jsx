...
const ChatContainer = ({selectedUser,setSelectedUser}) => {
  ...
  return selectedUser?(
    <div className='h-full overflow-scroll relative backdrop-blur-bg'>
      ...
      <img src={assets.profile_martin} className='rounded-full  w-8' alt="" />
      ...
      <div className='flex flex-col h-[calc(100%-120px)] overflow-y-scroll p-3 pb-6'>
        ...
        <div className='absolute bottom-0 left-0 right-0 flex items-center gap-3 p-3'>
          <div className='flex-1 flex items-center  rounded-full px-3 bg-gray-100/12 '>
            <input type="text" className='flex-1 text-sm p-3 border-none rounded-lg outline-none text-white placeholder-gray-200 text-white/50' placeholder='Send a message' />
